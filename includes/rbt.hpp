...
class RBT {
	public:
		...
		typedef	ft::RBTIterator<value_type const, node_type const>			    const_iterator;
	...
	public:
		...
		explicit RBT(const Cmp compare, const Alloc allocator)
